...
For questions about orders, shipping & returns, account help and products, chat to Goldie, the Missoma virtual assistant or fill out the form below.
                            </p>
                ...
                <section class="faq-section">
                    ...
                    <div class="faq-container">
                        ...
                        <button class="faq-question">
                            How do I find my bangle size? <span class="icon">+</span>
                        </button>
                        <div class="faq-answer">
                            <p>You can easily find your bangle size using our <a href="{{ url('about-us') }}?tab=Size-Guide">Size Guide</a></p>
                        </div>
                        </div>

                        <div class="faq-item">
                        <button class="faq-question">
                            What are my shipping options? <span class="icon">+</span>
                        </button>
                        <div class="faq-answer">
                            <p>We offer free shipping on Canada and US orders over $80 CAD and free shipping on worldwide orders over $200 CAD. We also offer free local pickup in Oakville, Ontario. Find more shipping information <a href="{{ url('about-us') }}?tab=tab=shipping">Here</a> </p>
                        </div>
                        </div>

                        <div class="faq-item">
                        <button class="faq-question">
                            What is your return policy? <span class="icon">+</span>
                        </button>
                        <div class="faq-answer">
                            <p>You can find our return policy <a href="{{ url('about-us') }}?tab=tab=policy">Here</a></p>
                        </div>
                        </div>

                        <div class="faq-item">
                        <button class="faq-question">
                           Do you have gift cards? <span class="icon">+</span>
                        </button>
                        <div class="faq-answer">
                            <p>We have virtual and physical gift cards available here</p>
                        </div>
                        </div>

                        <div class="faq-item">
                        <button class="faq-question">
                            Do you create custom jewelry? <span class="icon">+</span>
                        </button>
                        <div class="faq-answer">
                            <p>Yes, we do! If you would like to create a custom jewelry piece or set please book a virtual styling appointment <a href="{{ url('resource') }}?tab=jewelry-care">Here</a></p>
                        </div>
                        </div>
                    </div>
                    </section>
