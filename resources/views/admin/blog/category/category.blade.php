...
<main class="content-wrapper">
    ...
    <div class="container-fluid py-3">
        <div class="heading-top d-flex justify-content-between align-items-center">
            <h1 class="mb-0">All Blog Categories</h1>
            <a href="{{ route('admin.blog.category.create') }}" class="btn text-white " style="background-color: #6cc2b6; border-color: #6cc2b6;">+ Add Blog Category</a>
        </div>
    </div>
    <div class="client-table pt-2">
        <div class="row g-2 align-items-center mb-3">
            ...
            <div class="col-11">
                <input type="text" id="searchInput" class="form-control form-control-sm" placeholder="Search Blog Categories...">
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        var table = $('#color-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('admin.get-blog-categories-list') }}", // using same route
                type: 'GET',
                data: function(d) {
            ...
            language: {
                ...
                emptyTable: "No Blog Category found",
                zeroRecords: "No Blog Category found"
            }
        });
        var searchTimer;
    ...
    function confirmDelete(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // Use route URL
                const url = "{{ route('admin.blog.category.delete', ':id') }}".replace(':id', id);
