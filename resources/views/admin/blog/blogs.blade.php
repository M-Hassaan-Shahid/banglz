...
<main class="content-wrapper">
    ...
    <div class="client-table pt-2">
        <div class="row g-2 align-items-center mb-3">
            ...
            <div class="col-11">
                <input type="text" id="searchInput" class="form-control form-control-sm" placeholder="Search Blogs...">
            </div>
        </div>
        <table id="blog-table" style="width: 100%">
            <thead>
                <tr>
...
<script>
    $(document).ready(function() {
        var table = $('#blog-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('admin.get-blogs-list') }}", // using same route
                type: 'GET',
                data: function(d) {
